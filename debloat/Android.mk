...
LOCAL_OVERRIDES_PACKAGES += CarrierSetup ConnMO ConnMetrics Camera2 DevCamera CarrierLocation
...
LOCAL_OVERRIDES_PACKAGES += MaestroPrebuilt Maps MyVerizonServices Music NovaBugReportWrapper Ornament OemDmTrigger OBDM_Perm obdm_stub OBDM_Permissions OPScreenRecord OdadPrebuilt
LOCAL_OVERRIDES_PACKAGES += Phonograph PixelLiveWallpaperPrebuilt PlayAutoInstallConfig PrebuiltGmail Gallery2
LOCAL_OVERRIDES_PACKAGES += RecorderPrebuilt FMRadio 
LOCAL_OVERRIDES_PACKAGES += SafetyHubPrebuilt SCONE ScribePrebuilt Showcase SnapdragonCamera Snap2 Snap SimpleCalculator SimpleCalendar Snap SoundAmplifierPrebuilt  SprintDM SprintHM
